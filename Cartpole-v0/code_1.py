...
class GA:
    ...
    def crossover(self, DNA_list):
        ...
        #     l,r=r,l
        while(True):
            # print(DNA_list[0][0:l])
            # print(DNA_list[1][l:r+1])
            # print(DNA_list[0][r+1:32])
            # arr1=np.concatenate((np.concatenate((DNA_list[0][0:alpha[0]],DNA_list[1][alpha[0]:alpha[1]+1])),DNA_list[0][alpha[1]+1:15]))
            ...
            newDNAs.append(arr1)
            newDNAs.append(arr2)
            # arr2=np.concatenate((np.concatenate((DNA_list[1][0:l],DNA_list[0][l:r+1])),DNA_list[1][r+1:32]))
            # if(len(newDNAs)==self.population_size-2):
            #     break
            # newDNAs.append(arr2)
            
        #crossover
        # print(np.array(newDNAs).shape)
        return newDNAs
    ...
    def next_generation(self):
        ...
        # print(new_DNA_list)
        # print(np.array(new_DNA_list).shape)
    ...
    def evolve(self):
        ...
        # 2. Find maximum fitness of an individual in this generation and update best_fitness
            # print(np.array(new_fitness_list).shape)
